...
try {
    ...
    // Insert media
    $query = "INSERT INTO media (title, description, type, category, file_url, thumbnail_url, file_size, duration, video_id, download_url, external_url, featured, status, sort_order, created_at, updated_at) 
              VALUES (:title, :description, :type, :category, :file_url, :thumbnail_url, :file_size, :duration, :video_id, :download_url, :external_url, :featured, :status, :sort_order, NOW(), NOW())";
    ...
    ResponseHelper::success($media, 'Media created successfully');
