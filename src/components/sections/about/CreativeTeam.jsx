        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              <span className="font-semibold text-primary">Independence</span>,{" "}
              <span className="font-semibold text-primary">Honesty</span> and{" "}
              <span className="font-semibold text-primary">high Integrity</span>{" "}
              working together to serve our partners and communities across
              India in advancing the shared mission of safer roads and
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 items-stretch">
            {teamMembers.map((member) => (
              ...
              >
                {/* Team Member Photo */}
                <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  <img
                    src={member.image}
                    alt={member.name}
                ...
                <div className="text-center flex-1 flex flex-col justify-between">
                  <div className="min-h-[90px] flex flex-col justify-center">
                    ...
                    <p className="text-primary font-semibold text-sm leading-tight mb-1">
                      {member.position}
                    </p>
