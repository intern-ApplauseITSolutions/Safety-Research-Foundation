...
import { MapPin, Phone, Mail, Send, Clock, Building2, User, MessageSquare, CheckCircle, AlertCircle } from 'lucide-react';
...
const DynamicContact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use direct API call to the working endpoint
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
              ...
              <div className="w-full h-80 bg-gray-100 rounded-xl overflow-hidden border-2 border-dashed border-brand-black">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3161.8757539069616!2d73.8018944!3d18.5546065!3m2!1i1024!2i768!4f13.1!3m3!1m2!1i0!2s0x3bc2bfd2aecbe735%3A0x9b56fc17760f358b!2sSafety%20Research%20Foundation!5e1!3m2!1sen!2sin!4v1764851275918!5m2!1sen!2sin!4v1764851275918!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
              ...
              <div className="w-full h-80 bg-gray-100 rounded-xl overflow-hidden border-2 border-dashed border-brand-black">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3204.6857563394396!2d77.5997002!3d12.9622811!2m3!1f0!2f0!3f0!2m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae15e99bfd3bf7%3A0x187f0a14c44e549c!2sSafety%20Research%20Foundation!5e1!3m2!1sen!2sin!4v1764851415499!5m2!1sen!2sin!4v1764851415499!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
